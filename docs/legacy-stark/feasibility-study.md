...
> Status: founding analysis (historical). This document is the originating
> feasibility study that motivated the project. It is preserved verbatim as the
> source of intent and rationale. It is NOT the normative specification. The
> normative, maintained specification corpus lives at `../SPEC.md` (index),
> `docs/spec/`, and `docs/rfcs/`. Where this study and the normative corpus
> disagree, the corpus governs. Citations and external references in this study
> were synthesized at project inception; see `docs/spec/10-glossary.md` and the
> individual RFCs for the maintained, verified facts.
